<section id="tentang" class="flex flex-col lg:flex-row-reverse justify-center items-center mb-16 h-[100vh] bg-white overflow-hidden">
    <div class="px-6 w-full py-16 text-center">
        <h1 class="mt-16 md:mt-0 md:mb-4 text-2xl font-semibold tracking-wide text-black md:text-5xl xl:text-6xl text-wrap">Laporan Data Autoagra</h1>
